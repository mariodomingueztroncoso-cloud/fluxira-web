...
export default function Home() {
  ...
  // Validar y asignar el archivo PDF
  ...
  // Controlar la selección por clic
  ...
  // Forzar la apertura del selector de archivos al hacer clic en el recuadro
  ...
  // Manejadores para arrastrar y soltar (Drag and Drop)
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4 md:p-12 font-sans text-gray-900">
      ...
      <div className="z-10 w-full max-w-2xl flex flex-col items-center p-6 md:p-10 bg-white rounded-3xl shadow-sm border border-gray-100">
        ...
        {/* Formulario con Drag & Drop Corregido */}
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-sm text-gray-600">
          <div className="flex items-center gap-2">
            <span>📞</span>
            <a href="tel:+34600000000" className="hover:text-[#0087A5] hover:underline font-medium">
              +34 600 00 00 00
            </a>
          </div>
          <div className="flex items-center gap-2">
            <span>✉️</span>
            <a href="mailto:contacto@fluxira.es" className="hover:text-[#0087A5] hover:underline font-medium">
              contacto@fluxira.es
            </a>
          </div>
        </div>
